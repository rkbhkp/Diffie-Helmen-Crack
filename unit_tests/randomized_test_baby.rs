...
fn main() {
    ...
    for _ in 1..100 {
        ...
        let alice_broadcasts = (public_base as f64).powf(alice_sec as f64).round();
        let bob_broadcasts = (public_base as f64).powf(bob_sec as f64).round();
        let mutual_secret = (alice_broadcasts as f64).powf(bob_sec as f64).round();
